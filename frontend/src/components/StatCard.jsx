export default function StatCard({ icon: Icon, label, value, accent = 'accent', loading }) {
  ...
  return (
    <div className="bg-bg-card border border-border rounded-xl p-3 sm:p-5 flex items-center gap-3 sm:gap-4">
      ...
      <div className="min-w-0">
        ...
        <div className="text-lg sm:text-2xl font-semibold text-gray-100 mt-0.5">
